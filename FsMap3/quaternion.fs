...
/// Quaternion structure, single precision. Among other things, quaternions are
/// a convenient representation for rotations in 3-space. Quaternions corresponding to
/// rotations are normalized; this is not enforced automatically but is mentioned
/// in any methods requiring it.
[<NoComparison>]
type Quaternionf = struct
  ...
  override q.ToString() = "Quaternion(" + string q.w + ", " + string q.x + ", " + string q.y + ", " + string q.z + ")"
