...
let cubex (layout : LayoutFunction) (mix : MixOp) (color : CellColor) (fade : float32 -> float32) (frequency : float32) (v : Vec3f) =
...
let cubexd frequency v = cubex hifiLayout Mix.sum anyColor Fade.smooth frequency v


/// Cubex noise with the standard cell layout.
let cubexf fade frequency v = cubex hifiLayout Mix.sum anyColor fade frequency v
