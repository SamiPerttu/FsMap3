...
/// Radial weighted value noise basis.
let radial (layout : LayoutFunction) (color : CellColor) (fade : float32 -> float32) (frequency : float32) (v : Vec3f) =
...
/// Default radial basis value noise with the standard cell layout and the cubic fade function.
let inline radiald f v = radial hifiLayout anyColor Fade.cubic f v


/// Radial basis value noise with the standard cell layout.
let inline radialf fade f v = radial hifiLayout anyColor fade f v
